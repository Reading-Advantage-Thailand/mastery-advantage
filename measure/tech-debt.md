...
| 2026-07-07 | kst_srs_core_correctness | kst-srs.v3/v3.1 decisions self-approved under owner directive without human curriculum review | Medium | Open | Ratify before app adoption: H seeding constants, trendThreshold, backlog policy (v3); retention targets, hint/reveal caps, recency half-life, tercile banding (v3.1). |
